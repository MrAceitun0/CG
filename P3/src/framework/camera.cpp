...
void Camera::updateProjectionMatrix()
{
	...
	projection_matrix.M[2][0] = 0.0; 		projection_matrix.M[2][1] = 0.0;		projection_matrix.M[2][2] = (this->near_plane + this->far_plane) / (this->near_plane - this->far_plane);	projection_matrix.M[2][3] = -1.0;
	projection_matrix.M[3][0] = 0.0; 		projection_matrix.M[3][1] = 0.0;		projection_matrix.M[3][2] = 2*(this->near_plane + this->far_plane)/(this->near_plane - this->far_plane);	projection_matrix.M[3][3] = 0.0;
